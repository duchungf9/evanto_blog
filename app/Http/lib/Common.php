	...
	*/
    ...
    public static function metaDefault(){
        self::$meta = [
            ...
            'generator'                => '<meta name="generator" content="Publishing Team" />',
            'robots'                   => '<meta name="robots" content="' . Config::get('app.seo.robots', 'noindex,nofollow') . '" />',
            'googlebot'                => '<meta name="Googlebot" content="' . Config::get('app.seo.googlebot', 'noindex,nofollow,noarchive') . '" />',
            ...
            'og:locale'                => '<meta property="og:locale" content="vi_VN" />',
            ...
            'fb:image'                 => '<meta property="og:image" content="' . Config::get('app.seo.fb_image', 'http://sohagame.vn/wp-content/themes/sohahome/shg_frontend/images/website/logo.png') . '" />',
            ...
            'gg:image'                 => '<meta itemprop="image" content="' . Config::get('app.seo.gg_image', 'http://sohagame.vn/wp-content/themes/sohahome/shg_frontend/images/website/logo.png') . '" />',
            'google-site-verification' => '<meta name="google-site-verification" content="' . Config::get('app.seo.google', 'd-aD3FPkiyPppOLDimqmEa-Cqnu6lfGFM3djMhDgxxg') . '" />',
            'msvalidate.01'            => '<meta name="msvalidate.01" content="' . Config::get('app.seo.bing', 'EC4344E145C2A5E54A8915CF0D01E1F2') . '" />',
            'alexaVerifyID'            => '<meta name="alexaVerifyID" content="' . Config::get('app.seo.alexa', '2-k0cx1QGsON9HnSt13-e4dNLLQ') . '" />',
