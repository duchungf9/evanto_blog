...
@section('content')
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" ng-app="myApp" ng-controller="postController">
		...
		@endif
		<button class="btn btn-group-lg btn-success" onclick="javascript:window.location = '/admin/product'"><i class="fa fa-plus-circle"></i> Create New Product</button>
		<input type="text" ng-model="postFilter" ng-change="searchPost()" placeholder=" search products here...">
		<p></p>
	...
	<script>
		...
		app.controller('postController',function($scope,$http){
			...
			$scope.editCat = function(post){
				window.location = '{{URL::to('/')}}/admin/product/'+post.id;
			}
