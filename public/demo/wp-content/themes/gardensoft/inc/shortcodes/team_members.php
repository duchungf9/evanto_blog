         ...
         <?php if($link) echo $link_end; ?>
          ...
          <div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
                <div class="box-text-inner">
                 ...
                 <?php echo do_shortcode('[follow style="'.$icon_style.'" facebook="'.$facebook.'" twitter="'.$twitter.'" snapchat="'.$snapchat.'" email="'.$email.'" pinterest="'.$pinterest.'" instagram="'.$instagram.'" linkedin="'.$linkedin.'"]'); ?>
