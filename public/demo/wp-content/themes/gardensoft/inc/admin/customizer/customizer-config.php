...
function flatsome_enqueue_customizer_stylesheet() {
    ...
    wp_enqueue_script( 'flatsome-customizer-admin-js', get_template_directory_uri() . '/inc/admin/customizer/js/customizer.js', NULL, $version, 'all' );
    wp_enqueue_script( 'flatsome-header-builder-js', get_template_directory_uri() . '/inc/admin/customizer/js/header-builder.js', NULL, $version, 'all' );
...
function flatsome_customizer_live_preview() {
    ...
    wp_enqueue_script( 'flatsome-customizer-js', get_template_directory_uri() . '/inc/admin/customizer/js/frontend-helpers.js', NULL, $version, 'all' );
}
