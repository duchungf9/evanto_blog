...
function flatsome_refresh_footer_partials( WP_Customize_Manager $wp_customize ) {
  ...
  if ( ! isset( $wp_customize->selective_refresh ) ) {
	...
	$wp_customize->selective_refresh->add_partial( 'refresh-footer-css', array(
...
function flatsome_customizer_live_preview_footer() {
    wp_enqueue_script( 'flatsome-customizer-js-footer', get_template_directory_uri() . '/inc/admin/options/footer/options-footer.js', NULL, NULL, 'all' );
}
add_action( 'customize_preview_init', 'flatsome_customizer_live_preview_footer' );