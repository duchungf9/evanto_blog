...
?>
<?php add_thickbox(); ?>
<?php $flatsome_ver = wp_get_theme('flatsome');  ?>
<h1>
...
<h2 class="nav-tab-wrapper">
    ...
    <a href="<?php echo $url.'-plugins'; ?>" class="nav-tab <?php if($_GET['page'] == 'flatsome-panel-plugins') echo 'nav-tab-active'; ?>"><?php _e( 'Plugins', 'flatsome-admin' ); ?></a>
