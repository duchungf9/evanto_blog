...
function flatsome_refresh_header_partials( WP_Customize_Manager $wp_customize ) {
  ...
  if ( ! isset( $wp_customize->selective_refresh ) ) {
	...
	$wp_customize->selective_refresh->add_partial( 'header_bottom', array(
	    'selector' => '#wide-nav',
	    'settings' => array('nav_style_bottom','nav_size_bottom','header_mobile_elements_bottom','header_elements_bottom_left', 'header_elements_bottom_center', 'header_elements_bottom_right'),
	    'container_inclusive' => true,
	    'render_callback' => function() {
	...
	$wp_customize->selective_refresh->add_partial( 'header_main', array(
	    'selector' => '#masthead',
	    'settings' => array('nav_style','nav_size','header_divider'),
	    'container_inclusive' => true,
	    'render_callback' => function() {
	...
	$wp_customize->selective_refresh->add_partial( 'refresh-css', array(
