...
function flatsome_customizer_live_preview_layout() {
    wp_enqueue_script( 'flatsome-customizer-js-layout', get_template_directory_uri().'/inc/admin/options/layout/options-layout.js', 3.1, NULL, 'all' );
}
add_action( 'customize_preview_init', 'flatsome_customizer_live_preview_layout' );
